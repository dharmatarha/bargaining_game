function subjectiveVideoPlayback_V1(pairNo, labName)
...
instruction2 = ["Kérlek próbáld ki a csúszka használatát! " char(10),...
               "Ha felkészültél, vidd az egeret a 0-hoz, " char(10),...
...
%%%%%%%%%%%% Slider params %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    sliderColor   = [255 0 50]; % light blue 
    scaleColor    = [0 0 0];
    device        = 'mouse';
    %aborttime     = Inf;
...
%%%%% First while loop for "Tutorial" - drawing just the scale and an instruction %%%%%%
    ...
    Screen("TextSize", offwin, windowTextSize); 
    Screen('DrawText', offwin, instruction2, windowSize(3)/6, windowSize(4)/2, txtColor);
    ...
    while ~KbCheck && GetSecs < startTut+timeout && clickFlag==false  
      ...
      oldtex = offtex;  % Recycle movie image texture
