...
% simplest solution for checking if mouse is moving         
...
% another sort of working (but ugly) solution        
##        if sliderPos(count,:) > 0
##          fprintf('Subject is moving the mouse, position: ');
##          for k = 1:100
##            fprintf('\b\b\b\b\b\b\b\b\b\b%s ', sliderPos(k)); 
##          end
##        end
