function bgMain_v19(pairNo, player, labName, roundNo, tokenNo, confType, confNo, strangeImgNo)
%% Bargaining Game main experiment
%
% USAGE: bgMain_v19(pairNo, player, labName, roundNo, tokenNo, confType,... 
...
%    mustHaveAmountRect(3, :) = mustHaveAmountRect(3, :) + 0.05*xPix;
    ...
    udpPacketsNo = vidLength*5*vidSamplingRate;  % large enough number to cover all incoming udp packets in a game
