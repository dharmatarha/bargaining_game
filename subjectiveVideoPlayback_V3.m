function subjectiveVideoPlayback_V3(pairNo, labName)
...
%vidDir = '/home/mordor/CommGame/pair2/pair2_Mordor_freeConv.mov';
%moviename = ["pair", num2str(pairNo), "_", labName, ".mov"];
moviefilename = '/home/mordor/CommGame/pair2/pair2_Mordor_freeConv.mov';

%%%%%%% audio params %%%%%%%%

%audiofile = [vidDir, 'pair', num2str(pairNo), '_', labName, '.wav'];
audiofile = '/home/mordor/CommGame/pair2/pair2_Common_freeConv_audio.wav';
...
%%%%%%%%%%%% Slider params %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    HideCursor(win);
    %Screen('ConstrainCursor', win, 1, windowSize);
...
%%%%%%%%%% Loading the movie file in advance %%%%%%%%%%%%%
    ...
    flipTimes = nan(framecount, 1);
    texTimestamps = nan(framecount, 1);
