function bgMain_v15(pairNo, player, labName, roundNo, tokenNo, confType, confNo, strangeImgNo)
%% Bargaining Game main experiment
%
% USAGE: bgMain_v15(pairNo, player, labName, roundNo, tokenNo, confType,... 
...
%               config to use, one of 1:10, defaults to 1.
